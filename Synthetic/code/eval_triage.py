...
def main():
	...
	list_of_std = [.01,.05]#[0.001]#,.005,0.01,.05]
	...
	file_name = 'sigmoid_n500d5' # 'Gauss' 'Gauss_n500d5'
	...
	list_of_option = ['greedy']#['kl_triage','greedy','distort_greedy','diff_submod']#,'diff_submod']
